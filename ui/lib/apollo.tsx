 ...
 */
export function withApollo<PageProps extends object,
  PageInitialProps = PageProps>(PageComponent: NextPage<PageProps, PageInitialProps>, { ssr = true } = {}) {
  const WithApollo: NextPage<PageProps & WithApolloProps,
